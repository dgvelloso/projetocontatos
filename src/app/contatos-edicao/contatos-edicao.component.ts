...
//classe do router pra capturar parâmetros passados na url do componente
...
export class ContatosEdicaoComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //capturando o id do contato enviado pela URL
    var idContato = this.activatedRoute.snapshot.paramMap.get('id') as string;

    // buscando o contato na API através do ID
    this.contatosService.getById(idContato).subscribe(
